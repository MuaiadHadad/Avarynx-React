!(function (e, t) {
  ...
  function se(e, t, o) {
    ...
    if ('vimeo' == s.type || 'youtube' == s.type) {
      ...
      ('vimeo' == s.type
        ...
        : 'youtube' == s.type && (i = 'https://www.youtube-nocookie.com/embed/'),
        (x =
  ...
  function re(e) {
    if (Y) {
      ...
      ((X = Q - D),
        X < 0 && L && ((e = j), (t = !0)),
        X > 0 && w && ((e = H), (t = !0)),
        Math.abs(X) >= 50 && t ? ue(e) : ((a.style.marginLeft = 0), (a.style.opacity = 1)));
    }
  }
  function le(e) {
    if (Y && !y) {
  ...
  function de(e) {
    ...
    (e.settings.share &&
      ...
      !j && m && (j = f[0]),
      !H && m && (H = f[f.length - 1]),
      f.length >= 1 ? ((p = l + 1), (t.innerHTML = p + ' / ' + f.length)) : (p = 1),
    ...
    switch (r.dataset.vbtype) {
      case 'iframe':
        ((e = q),
          ...
          a.classList.add('vbox-loading'),
          (x =
            '<div class="venoratio venoratio-' + t + '"><iframe src="' + e + '"></iframe></div>'),
