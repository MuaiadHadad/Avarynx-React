    ...
    success: {
      ...
      icon: (
        ...
        >
          ...
          <path d="M20 12c0 4.418-3.582 8-8 8s-8-3.582-8-8 3.582-8 8-8" />
        </svg>
      ),
    },
    warning: {
          ...
          return (
            ...
            >
              ...
              <div className="relative flex items-start gap-3">
                <div className="mt-[2px] shrink-0 text-white/90 drop-shadow-sm">{style.icon}</div>
              ...
              <motion.div
                ...
                style={{
                  background:
                    'linear-gradient(125deg, rgba(255,255,255,0.25), rgba(255,255,255,0) 60%)',
